...
CREATE TABLE PHRASEACTOR (ID NUMBER(19) NOT NULL, DTYPE VARCHAR(31), name VARCHAR NOT NULL UNIQUE, PRIMARY KEY (ID))
...
CREATE TABLE Phrase (ID NUMBER(19) NOT NULL, agressiveLevel NUMBER(10) NOT NULL, clearLevel NUMBER(10) NOT NULL, expression VARCHAR NOT NULL, longLevel NUMBER(10) NOT NULL, name VARCHAR NOT NULL UNIQUE, PRIMARY KEY (ID))
...
ALTER TABLE DoctorActor ADD CONSTRAINT FK_DoctorActor_ID FOREIGN KEY (ID) REFERENCES PHRASEACTOR (ID)
ALTER TABLE PatientActor ADD CONSTRAINT FK_PatientActor_ID FOREIGN KEY (ID) REFERENCES PHRASEACTOR (ID)
