...
CREATE TABLE DialogueSession (ID NUMBER(19) NOT NULL, name VARCHAR NOT NULL UNIQUE, doctorPhrase NUMBER(19), patientPhrase NUMBER(19), PRIMARY KEY (ID))
CREATE TABLE DoctorActor (ID NUMBER(19) NOT NULL, name VARCHAR NOT NULL UNIQUE, PRIMARY KEY (ID))
CREATE TABLE DoctorPhrase (ID NUMBER(19) NOT NULL, agressiveLevel NUMBER(10) NOT NULL, clearLevel NUMBER(10) NOT NULL, expression VARCHAR NOT NULL, longLevel NUMBER(10) NOT NULL, name VARCHAR NOT NULL UNIQUE, phraseActor BLOB NOT NULL, primitiveType NUMBER(10) NOT NULL, PRIMARY KEY (ID))
...
ALTER TABLE DialogueSession ADD CONSTRAINT FK_DialogueSession_patientPhrase FOREIGN KEY (patientPhrase) REFERENCES PatientPhrase (ID)
ALTER TABLE DialogueSession ADD CONSTRAINT FK_DialogueSession_doctorPhrase FOREIGN KEY (doctorPhrase) REFERENCES DoctorPhrase (ID)
