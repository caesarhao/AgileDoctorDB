...
CREATE TABLE DoctorPhrase (ID NUMBER(19) NOT NULL, effDisturbance NUMBER(10,5) NOT NULL, effTrust NUMBER(10,5) NOT NULL, expression VARCHAR NOT NULL, name VARCHAR NOT NULL UNIQUE, phraseActor BLOB NOT NULL, primitiveType NUMBER(10) NOT NULL, PRIMARY KEY (ID))
