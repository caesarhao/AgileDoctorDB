...
CREATE TABLE Phrase (ID NUMBER(19) NOT NULL, agressiveLevel NUMBER(10) NOT NULL, clearLevel NUMBER(10) NOT NULL, expression VARCHAR NOT NULL, longLevel NUMBER(10) NOT NULL, name VARCHAR NOT NULL UNIQUE, primitiveType NUMBER(10) NOT NULL, PRIMARY KEY (ID))
